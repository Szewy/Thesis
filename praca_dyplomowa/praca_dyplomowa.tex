...
\begin{figure}[H]
	\centering
	\subfigure[]
	{\label{fig:a}\includegraphics[width=0.22\textwidth]{\ImgPath/rys/elementy_strukturalne/1.png}}
	\subfigure[]
	{\label{fig:b}\includegraphics[width=0.22\textwidth]{\ImgPath/rys/elementy_strukturalne/2.png}}
	\subfigure[]
	{\label{fig:b}\includegraphics[width=0.22\textwidth]{\ImgPath/rys/elementy_strukturalne/3.png}}
...
\begin{figure}[H]
	\centering
	\subfigure[Obraz początkowy]
	{\label{fig:a}\includegraphics[width=0.32\textwidth]{\ImgPath/rys/operacje_morfologiczne/otwarcie_szablon.png}}
	\subfigure[Obraz wyjściowy]
	{\label{fig:b}\includegraphics[width=0.32\textwidth]{\ImgPath/rys/operacje_morfologiczne/otwarcie2.png}}
...
\begin{figure}[H]
	\centering
	\subfigure[Obraz początkowy]
	{\label{fig:a}\includegraphics[width=0.32\textwidth]{\ImgPath/rys/operacje_morfologiczne/zamkniecie_szablon.png}}
	\subfigure[Obraz wyjściowy]
	{\label{fig:b}\includegraphics[width=0.32\textwidth]{\ImgPath/rys/operacje_morfologiczne/zamkniecie2.png}}
...
\bibitem{knn2}{Metoda K Najbliższych Sąsiadów, http://home.agh.edu.pl/~horzyk/lectures/miw/KNN.pdf, dostęp: styczeń 2019}
