...
\begin{figure}[H]
	\centering
	\subfigure[Wykres]
	{\label{fig:b}\includegraphics[width=0.42\textwidth]{\ImgPath/rys/funkcje_aktywacji/relu.png}}
	\subfigure[Wzór]
...
\begin{figure}[H]
	\centering
	\subfigure[Wykres]
	{\label{fig:b}\includegraphics[width=0.42\textwidth]{\ImgPath/rys/funkcje_aktywacji/sigmoid.png}}
	\subfigure[Wzór]
	{\label{fig:a} {{\large $ f(x) = \frac{1}{1 + exp(-\beta x)} $ \par}  }}
...
\begin{figure}[H]
	\centering
	\subfigure[Wykres]
	{\label{fig:b}\includegraphics[width=0.42\textwidth]{\ImgPath/rys/funkcje_aktywacji/tanh.png}}
	\subfigure[Wzór]
	{\label{fig:a} {{\large $ f(x) = tanh(\beta x) $ \par}  }}
