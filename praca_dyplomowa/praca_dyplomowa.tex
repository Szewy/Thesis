...
\begin{figure}[H]
	\centering
	\subfigure[]
	{\label{fig:a}\includegraphics[width=0.25\textwidth]{\ImgPath/rys/elementy_strukturalne/1.png}}
	\subfigure[]
	{\label{fig:b}\includegraphics[width=0.25\textwidth]{\ImgPath/rys/elementy_strukturalne/2.png}}
	\subfigure[]
	{\label{fig:b}\includegraphics[width=0.25\textwidth]{\ImgPath/rys/elementy_strukturalne/3.png}}
...
\begin{figure}[H]
	...
	\subfigure[Obraz początkowy]
		{\label{fig:a}\includegraphics[width=0.35\textwidth]{\ImgPath/rys/operacje_morfologiczne/erozja_szablon.png}}
	\subfigure[Obraz wyjściowy]
		{\label{fig:b}\includegraphics[width=0.35\textwidth]{\ImgPath/rys/operacje_morfologiczne/erozja2.png}}
...
\begin{figure}[H]
	\centering
	\subfigure[Obraz początkowy]
	{\label{fig:a}\includegraphics[width=0.35\textwidth]{\ImgPath/rys/operacje_morfologiczne/dylatacja_szablon.png}}
	\subfigure[Obraz wyjściowy]
	{\label{fig:b}\includegraphics[width=0.35\textwidth]{\ImgPath/rys/operacje_morfologiczne/dylatacja2.png}}
...
\begin{figure}[H]
	\centering
	\subfigure[Obraz początkowy]
	{\label{fig:a}\includegraphics[width=0.31\textwidth]{\ImgPath/rys/operacje_morfologiczne/otwarcie_szablon.png}}
	\subfigure[Obraz wyjściowy]
	{\label{fig:b}\includegraphics[width=0.31\textwidth]{\ImgPath/rys/operacje_morfologiczne/otwarcie2.png}}
...
\begin{figure}[H]
	\centering
	\subfigure[Obraz początkowy]
	{\label{fig:a}\includegraphics[width=0.31\textwidth]{\ImgPath/rys/operacje_morfologiczne/zamkniecie_szablon.png}}
	\subfigure[Obraz wyjściowy]
	{\label{fig:b}\includegraphics[width=0.31\textwidth]{\ImgPath/rys/operacje_morfologiczne/zamkniecie2.png}}
...
\begin{figure}[H]
	\centering
	\subfigure[Tło]
	{\label{fig:a}\includegraphics[width=0.3\textwidth]{\ImgPath/rys/bs/tlo.png}}
	\subfigure[Obraz binarny]
	{\label{fig:b}\includegraphics[width=0.3\textwidth]{\ImgPath/rys/bs/obraz.png}}
	\subfigure[Różnica]
	{\label{fig:b}\includegraphics[width=0.3\textwidth]{\ImgPath/rys/bs/bin.png}}
...
\begin{figure}[H]	
	\centering
	\includegraphics[width=0.6\textwidth]{\ImgPath/rys/rgb.png}
...
\begin{figure}[H]
	\centering
	\subfigure[Wykres]
	{\label{fig:b}\includegraphics[width=0.36\textwidth]{\ImgPath/rys/funkcje_aktywacji/relu.png}}
	\subfigure[Wzór]
	{\label{fig:a} {{\large $ f(x) = max(0, ax) $ \par}  }}
...
\begin{figure}[H]
	\centering
	\subfigure[Wykres]
	{\label{fig:b}\includegraphics[width=0.36\textwidth]{\ImgPath/rys/funkcje_aktywacji/sigmoid.png}}
	\subfigure[Wzór]
	{\label{fig:a} {{\large $ f(x) = \frac{1}{1 + e^{-\beta x}} $ \par}  }}
...
\begin{figure}[H]
	\centering
	\subfigure[Wykres]
	{\label{fig:b}\includegraphics[width=0.36\textwidth]{\ImgPath/rys/funkcje_aktywacji/tanh.png}}
	\subfigure[Wzór]
	{\label{fig:a} {{\large $ f(x) = \frac{e^x - e^{-x}}{e^x+e^{-x}} $ \par}  }}
...
\paragraph{k = 9}
	...
	\begin{figure}[H]
		\centering
		{\label{fig:b}\includegraphics[width=0.50\textwidth]{\ImgPath/rys/klasyfikatory/knn.png}}
...
\bibitem{Tadeusiewicz}{Ryszard Tadeusiewicz, ,,Komputerowa analiza i przetwarzanie obrazów'', 1997}
\bibitem{Osowski}{Osowski Stanisław, ,,Metody i narzędzia eksploracji danych'', 2013}
\bibitem{Bradski}{Adrian Kaehler[tłum], Łukasz Piwko[tłum], Gary R Bradski, ,,OpenCV 3 : komputerowe rozpoznawanie obrazu w C++ przy użyciu biblioteki OpenCV'', 2018}
\bibitem{Rafajlowicz}{Ewaryst Rafajłowicz, Wojciech Rafajłowicz, Andrzej Rusiecki, ,,Algorytmy przetwarzania obrazów i wstęp do pracy z biblioteką OpenCV'', 2009}
\bibitem{Slater}{Daniel Slater, Gianmario Spacagna, Peter Roelants, Valentino Zocca, ,,Deep Learning. Uczenie głębokie z językiem Python. Sztuczna inteligencja i sieci neuronowe'', 2018}
\bibitem{Marmanis}{Douglas McIlwraith, Haralambos Marmanis, Dmitry Babenko, ,,Algorithms of the Intelligent Web 2nd Edition'', 2016}
\bibitem{Chollet}{François Chollet, ,,Deep Learning with Python'', 2017}
\bibitem{Raschka}{Sebastian Raschka, ,,Python. Uczenie maszynowe'', 2017}
\bibitem{Geron}{Aurélien Géron, Krzysztof Sawka[tłum], ,,Uczenie maszynowe z użyciem Scikit-Learn i TensorFlow'', 2018}
\bibitem{Ramsundar}{Bharath Ramsundar, Reza Bosagh Zadeh, ,,TensorFlow for Deep Learning. From Linear Regression to Reinforcement Learning'', 2018}
\bibitem{Serra}{Jean Serra, ,,Image Analysis and Mathematical Morphology'', 1983}
\bibitem{Burger}{Wilhelm Burger, Mark J. Burge, ,,Principles of Digital Image Processing: Fundamental Techniques'', 2009}

\bibitem{Media}{O'Reilly Media, ,,Learning Python 4th Edition'', 2009}
\bibitem{Lie}{Hetland Magnus Lie, ,,Beginning Python'', 2016}

\bibitem{tiobe}{Tiobem, https://www.tiobe.com/tiobe-index/, dostęp: grudzień 2018}
\bibitem{analizaobrazu}{Analizaobrazu, http://analizaobrazu.x25.pl/articles/19, dostęp: styczeń 2019}
\bibitem{opencvc}{OpenCV docs, https://docs.opencv.org/3.4/d1/d32/tutorial\_py\_contour\_properties.html, dostęp: styczeń 2019}
\bibitem{mumuw}{mimuw.edu.pl http://mst.mimuw.edu.pl/lecture.php?lecture=syd\&part=Ch2, dostęp: styczeń 2019}
\bibitem{opencva}{OpenCV docs, https://opencv.org/about.html, dostęp: styczeń 2019}
\bibitem{tensorflow}{TensorFlow.org https://www.tensorflow.org/guide/graphs, dostęp: styczeń 2019}
\bibitem{keras}{Keras.io, https://keras.io/, dostęp: styczeń 2019}
\bibitem{convex}{Learningopencv, https://www.learnopencv.com/convex-hull-using-opencv-in-python-and-c/, dostęp: styczeń 2019}
\bibitem{pyimagesearch}{Pyimagesearch, https://www.pyimagesearch.com/2016/03/28/measuring-size-of-objects-in-an-image-with-opencv/, dostęp: styczeń 2019}
\bibitem{opencvm}{OpenCV docs, https://docs.opencv.org/3.0-beta/doc/py\_tutorials/py\_imgproc/\\py\_morphological\_ops/py\_morphological\_ops.html, dostęp: styczeń 2019}
\bibitem{opencvco}{OpenCV docs, https://docs.opencv.org/3.4.2/df/d9d/tutorial\_py\_colorspaces.html, dostęp: styczeń 2019}
\bibitem{Softmax}{Mechanizm uwagi w sieciach neuronowych, http://moria.umcs.lublin.pl/\\sphinx/src/machine\_learning/attention.html, dostęp: styczeń 2019}
