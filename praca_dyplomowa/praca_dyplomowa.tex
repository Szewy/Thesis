...
\section{Sieci neuronowe}
	...
	\begin{figure}[H]	
		\centering
		\includegraphics[width=0.4\textwidth]{\ImgPath/rys/czarna_skrzynka.png}
	...
	Sztuczne neurony na podstawie danych podanych na wejściu, wykonują pewną funkcję tak zwaną funkcję aktywacji. Często wykorzystuje się tą samą funkcję aktywacji dla tej samej warstwy, a czasami można wykorzystać tą samą funkcję aktywacji nawet o do całej sieci neuronowej. 
	...
	Oraz wzor wartosci neuronu dla okreslonego wejscia, wzor macierzowy
...
Przy uczeniu sieci najczestrzyszym algorytmem ich uczenue jest wsteczna propagacja błędu.
Znajac wartosc wyjsiową dla danego zbioru wartosci wejsciowych jestesmy wstanie policzyc blad dzialania sieci. Ten blad jest przekazywany interacyjnie do polaczynych w poprzednich wartwach neurow, a nastepnie liczony blad tych neuronow wykorzystujac przekazane wartosci bledow. Uczenie sieci polega na dostrajaniu wartosci wag, w zaleznosci od bledu w danym neuronie. Waznym parametrem przy uczeniu sieci jest parametr szybkosci uczeniu. Mowi on o szybkosci uczenia sie sieci neuronowych.

Softmax jako funkcja na wyjscie:
Opis....
